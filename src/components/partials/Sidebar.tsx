...
function Sidebar() {
    return (
        <div className={`text-neutral-100 px-6 pb-5 pt-1 h-full flex flex-col justify-between`}>
            <ul className={`flex flex-col gap-y-5`}>
                ...
                <li className={``}>
                    <Link className={`flex items-end gap-x-4 text-2xl hover:bg-neutral-600/30 rounded-full w-fit pr-7 pl-3 py-3 transition`} to={`/home`}>
                        <MdHomeFilled className={`size-8`}/>
                        Home
                    </Link>
                </li>
                <li>
                    <Link className={`flex items-end gap-x-4 text-2xl hover:bg-neutral-600/30 rounded-full w-fit pr-7 pl-3 py-3 transition`} to={`/explore`}>
                        <HiMiniMagnifyingGlass className={`size-8`}/>
                        Explore
                    </Link>
                </li>
                <li>
                    <Link className={`flex items-end gap-x-4 text-2xl hover:bg-neutral-600/30 rounded-full w-fit pr-7 pl-3 py-3 transition`} to={`/notifications`}>
                        <BsBell className={`size-8`}/>
                        Notifications
                    </Link>
                </li>
                <li>
                    <Link className={`flex items-end gap-x-4 text-2xl hover:bg-neutral-600/30 rounded-full w-fit pr-7 pl-3 py-3 transition`} to={`/profile`}>
