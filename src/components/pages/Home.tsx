...
function Home() {
    ...
    return (
        <div className="grid grid-cols-1 bg-black w-full h-screen items-end justify-center text-zinc-200">
            <div className={` flex flex-col md:flex-row justify-around`}>
                ...
                <div className="w-full md:w-auto flex flex-col items-center md:block">
                    ...
                    <div className="max-w-[21rem] flex flex-col items-center md:block">
                        ...
                        <Link to="/register"  className="block text-center bg-sky-500 w-full py-3 rounded-3xl text-gray-100 mt-2 font-semibold hover:bg-sky-600 transition">
