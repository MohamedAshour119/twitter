        ...
        {/*  Cover section  */}
            <div className={`my-32`}>
                <div className={`bg-gray-600`}>
                    <div className={`bg-neutral-950 hover:bg-neutral-900 text-2xl flex justify-center items-center rounded-full h-9 w-9 transition`}>
                        <TbCameraPlus />
                    </div>
                </div>
            {/*  Avatar  */}
                <div>
                    <img src={`${baseUrl}/storage/${user?.avatar}`} alt=""
                         className={`object-cover w-32 h-32 rounded-full ${!user ? 'invisible' : ''}`}/>
                </div>
            </div>
        {/*  More info  */}
            <div>
